    ...
    <div class="p-4 sm:ml-64">
        <div class="rounded-lg mt-14">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6" id="profile">
                ...
                <div class="mt-4">
                    <form action="{{ route('profil.update_nama') }}" method="POST" class="space-y-4 md:space-y-6">
                        @csrf
                        @method('PUT')
                    ...
                    <form action="{{ route('profil.update_phone') }}" method="POST" class="space-y-4 md:space-y-6">
                        @csrf
                        @method('PUT')
                        <div class="flex gap-3 items-center">
                            <label for="phone"
